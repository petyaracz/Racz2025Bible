...
lm4 = lmer(wc ~ work3 + (1| book/chapter), data = d2)

lm1b = lmer(bigram_perplexity ~ 1 + (1| book/chapter), data = d2)
lm2b = lmer(mdl_over_dl ~ 1 + (1| book/chapter), data = d2)
lm3b = lmer(type_token_ratio ~ 1 + (1| book/chapter), data = d2)
lm4b = lmer(wc ~ 1 + (1| book/chapter), data = d2)
